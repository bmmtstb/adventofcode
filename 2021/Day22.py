...
def are_cubes_intersecting(cub1: Cuboid, cub2: Cuboid) -> bool:
    ...
    # completely outside
    if any(cub1[dim][0] > cub2[dim][1] or cub1[dim][1] < cub2[dim][0] for dim in range(1, 4)):
        return False
    return True
...
def is_cube_subset(cub1: Cuboid, cub2: Cuboid) -> bool:
    ...
    return all(cub1[dim][0] <= cub2[dim][0] and cub1[dim][1] >= cub2[dim][1] for dim in range(1, 4))
...
def count_active(steps: List[Cuboid], initialization: bool = False) -> int:
    ...
    for step in steps:
        ...
        if initialization and any(step[i][0] < -50 or step[i][1] > 50 for i in range(1, 4)):
            continue
    ...
    return sum((cube[1][1] - cube[1][0] + 1) * (cube[2][1] - cube[2][0] + 1) * (cube[3][1] - cube[3][0] + 1) for cube in act_cubes)


class Test2021Day22(unittest.TestCase):

    @parameterized.expand([
        [(True, (0, 10), (0, 10), (0, 10)), (True, (0, 10), (0, 10), (0, 10)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (10, 11), (10, 11), (10, 11)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (1, 1), (4, 4), (3, 3)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (-10, -1), (-10, -1), (-2, -1)), False],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (1, 2), (3, 4), (5, 6)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (-2, -1), (-10, -1), (4, 100)), False],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (-2, -1), (10, 100), (-10, -1)), False],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (-100, 100), (-2, -1), (-10, -1)), False],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (11, 12), (-2, -1), (11, 14)), False],
        [(True, (11, 12), (10, 10), (10, 12)), (True, (10, 10), (10, 10), (10, 10)), False],
        [(True, (11, 12), (10, 10), (10, 12)), (False, (9, 11), (9, 11), (9, 11)), True],
    ])
    def test_intersecting(self, b1, b2, b):
        self.assertEqual(are_cubes_intersecting(b1, b2), b)

    @parameterized.expand([
        [(True, (0, 10), (0, 10), (0, 10)), (True, (0, 10), (0, 10), (0, 10)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (10, 10), (10, 10), (10, 10)), True],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (10, 11), (10, 11), (10, 11)), False],
        [(True, (0, 10), (0, 10), (0, 10)), (True, (1, 1), (4, 4), (3, 3)), True],
    ...
    def test_subset(self, b1, b2, b):
        self.assertEqual(is_cube_subset(b1, b2), b)


    @parameterized.expand([
        [(True, (0, 10), (0, 10), (0, 10)), (False, (0, 10), (0, 10), (0, 10)), set()],
        [(True, (0, 10), (0, 10), (0, 10)), (False, (-1, 11), (-1, 11), (-10, 100)), set()],
        [(True, (0, 10), (0, 10), (0, 10)), (False, (0, 1), (0, 1), (0, 1)), {  # subset with cuts at border
            # (True, (0, -1), (0, 10), (0, 10)),
            (True, (2, 10), (0, 10), (0, 10)),
            # (True, (0, 1), (0, -1), (0, 10)),
            (True, (0, 1), (2, 10), (0, 10)),
        ...
        [(True, (0, 10), (0, 10), (0, 10)), (False, (2, 4), (-100, 100), (-100, 100)), {
            (True, (0, 1), (0, 10), (0, 10)),
            (True, (5, 10), (0, 10), (0, 10)),
        ...
        [(True, (0, 10), (0, 10), (0, 10)), (False, (-100, 100), (2, 4), (-100, 100)), {
        ...
        [(True, (0, 10), (0, 10), (0, 10)), (False, (-100, 100), (-100, 4), (-100, 100)), {
            # (True, (-100, 100), (0, 10), (0, 10)),
            # (True, (-100, 100), (0, 10), (0, 10)),
        ...
        [(True, (0, 10), (0, 10), (0, 10)), (False, (1, 2), (3, 4), (5, 6)), {  # subset
            (True, (0, 0), (0, 10), (0, 10)),
            (True, (3, 10), (0, 10), (0, 10)),
            (True, (1, 2), (0, 2), (0, 10)),
            (True, (1, 2), (5, 10), (0, 10)),
        ...
        [(True, (10, 10), (10, 12), (10, 12)), (False, (9, 11), (9, 11), (9, 11)), {
            # (True, (10, 8), (), ()),
            # (True, (12, 10), (), ()),
            # (True, (10, 10), (10, 8), ()),
    ...
    def test_split_into_cubes(self, c1, c2, cubes):
